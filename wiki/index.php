...
$WIKI_TITLE = 'MiCertify API Documentation'; // name of the site
$PASSWORD = ''; // SHA1 hash
...
$T_PREVIEW = 'Preview';
$T_SEARCH = 'Search';
$T_SEARCH_RESULTS = 'Search in results';
$T_LIST_OF_ALL_PAGES = 'Page Index';
$T_RECENT_CHANGES = 'Recent changes';
$T_LAST_CHANGED = 'Updated';
$T_HISTORY = 'History';
$T_RESTORE = 'Restore';
...
if(!$action)
	...
	elseif(!file_exists("$PG_DIR$page.txt")) die(header("Location:404.html"));
...
// commenting this out makes it read only
