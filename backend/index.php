...
$url = "http://www.micertify.com/api";

$headers = array(
 'X-Papi-Application-Id: micertify.com'
);
$fields = array(
 "data" => $_POST["data"]
);
...
<PRE>
{ "login" : { "username":"h3rb", "password":"guest" } }
{ "action": "forgot", "email":"your@gmail.com" }
{ "action": "me" }
{ "action": "create", "subject" : "test", "data" : {} }
{ "action": "create", "subject" : "q", "for": test.id, "data" : {} }
{ "action": "create", "subject" : "a", "for": q.id, "data" : {} }
{ "action": "modify", "subject" : "test", "data" : {} }
{ "action": "logout" }
</PRE>
</TD></TR></TABLE>
<?php
